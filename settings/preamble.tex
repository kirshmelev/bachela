...
\usepackage[left=3cm, right=1cm, top=1cm, bottom=1cm]{geometry} % поля страницы
...
% Методичка требует номер раздела без точки после номера: "2.3 Название".
\makeatletter
\renewcommand{\@seccntformat}[1]{\csname the#1\endcsname\quad}
\makeatother

\newcommand{\vkrsection}[1]{%
  \refstepcounter{section}%
  \phantomsection%
  \addcontentsline{toc}{section}{\protect\numberline{\thesection}#1}%
  \par\bigskip\noindent\textbf{\thesection\quad #1}\par\nobreak\medskip%
}
