  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.58\linewidth}
      \begin{itemize}
        ...
        \item Для нотариата важны проверяемые сведения о составе цифрового наследства и воле владельца.
      \end{itemize}
    \end{column}
...
\begin{frame}{Цель и задачи работы}
  ...
  frame{Объект и предмет исследования}
...
\begin{frame}{Существующие решения}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\linewidth}
      ...
      \begin{itemize}
        ...
        \item механизмы Google, Apple, Microsoft и специализированные сервисы управления цифровым наследством.
      \end{itemize}
    \end{column}
    \begin{column}{0.48\linewidth}
  ...
  \vspace{0.2cm}
  \begin{block}{Вывод}
    Требуется доверенная и безопасная информационная система, встроенная в наследственный контур.
  \end{block}
\end{frame}
